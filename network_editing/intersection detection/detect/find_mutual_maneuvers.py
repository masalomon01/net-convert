...
if __name__ == '__main__':
    turn_link_pairs_filepath = r'D:\Metropia_docs\P1\reviewedSE\data\tucson\turn_link_pairs.csv'
    mutual_maneuvers_filepath = r'D:\Metropia_docs\P1\reviewedSE\data\tucson\mutual_maneuvers.json'
    find_mutuals(turn_link_pairs_filepath, mutual_maneuvers_filepath)